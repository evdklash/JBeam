...
public interface FEModel {
    ...
    public Enum getSpaceDimension();
    public long getNumDofs(); // Return the total number of degrees of freedom
    ...
    //Todo: Implement method to store the model solution with the model
